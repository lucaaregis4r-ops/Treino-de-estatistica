...
A versão 0.4.0 amplia o scout digitado com registro visual/gestual, análises táticas e relatórios editáveis com gráficos selecionados.
...
O executável portátil da versão 0.4.0 é gerado em `distribuicao/Scout-Trainer-0.4.0-Portable.exe` e pode ser copiado para o Google Drive ou anexado ao release do GitHub.
