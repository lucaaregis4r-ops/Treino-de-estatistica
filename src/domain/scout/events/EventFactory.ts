...
export class EventFactory {
  ...
  create(
    ...
    return success({
      ...
      ...(context.setterPlayerId ? { setterPlayerId: context.setterPlayerId } : {}),
      ...(context.setterPosition ? { setterPosition: context.setterPosition } : {}),
      ...(context.formationState ? { formationState: context.formationState } : {}),
