...
- A suíte global e parte do AppFlow/critical-flow já tinham falhas de contrato de UI documentadas em `docs/versoes/v0.4/interface/ENTREGA.md` e `VALIDACAO.md`; não foram ampliadas para refatoração geral.
