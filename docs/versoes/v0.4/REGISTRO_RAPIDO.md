> **Versão/escopo:** Base 0.4.0; ajuste de 14/09/2026.
...
- Evidências sintéticas em `output/registro-rapido/`; resultado dos comandos finais em `docs/versoes/v0.4/interface/ESTADO.md`. Nenhuma base real do usuário foi usada para abortar transações.
