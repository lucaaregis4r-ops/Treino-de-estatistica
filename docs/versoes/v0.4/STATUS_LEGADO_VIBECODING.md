> **Versão/escopo:** 0.4 — status histórico do refinamento.
...
Plano: `docs/versoes/v0.4/SCOUT_TRAINER_0.4_PLANO_REFINAMENTO_CODEX.md`. Este arquivo é a fonte
...
`docs/versoes/v0.4/SCOUT_TRAINER_0.4_PLANO_REFINAMENTO_CODEX.md`, conforme o acompanhamento vigente
