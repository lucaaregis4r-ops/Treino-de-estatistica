...
1. Extraia esta pasta dentro de `docs/` do seu projeto. Caminho recomendado: `docs/versoes/v0.4/interface/`.
...
```text
Leia docs/versoes/v0.4/interface/LEIA_PRIMEIRO.md, CONTRATO_DESIGN.md,
...
docs/versoes/v0.4/interface/ESTADO.md.
...
```text
Retome a etapa em andamento de docs/versoes/v0.4/interface/ESTADO.md.
...
em docs/versoes/v0.4/interface/. A divergência observada é: [DESCREVER].
